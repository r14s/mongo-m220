...
export default class MoviesDAO {
  ...
  static async getMovies({
    ...
    */
    ...
    const totalSkipped = moviesPerPage * page
    const displayCursor = cursor.limit(moviesPerPage).skip(totalSkipped)
  ...
  static async getMovieByID(id) {
    try {
      ...
      */
      ...
      if (`${e}` === "Error: Argument passed in must be a single String of 12 bytes or a string of 24 hex characters") return null
      throw e
    }
  }
}
